...
@Component({
  ...
  templateUrl: './preview-comments-chat.component.html',
  styleUrls: ['./preview-comments-chat.component.css']
})
export class PreviewCommentsChatComponent implements OnInit {
